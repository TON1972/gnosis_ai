...
export default function StudyChatPage() {
  ...
  const { refetch: refetchCredits } = trpc.credits.balance.useQuery();
        ...
        <div className="container mx-auto max-w-4xl space-y-8 pb-10">
          ...
          {messages.map((msg, idx) => (
            <div key={idx} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
              <div className={`max-w-[92%] md:max-w-[85%] p-6 rounded-2xl shadow-xl border-2 animate-in fade-in slide-in-from-bottom-3 duration-500 ${
                msg.role === "user" 
