...
export const plans = pgTable("plans", {
  ...
  nameEn: varchar("nameEn", { length: 50 }),
  displayNameEn: varchar("displayNameEn", { length: 100 }),
  descriptionEn: text("descriptionEn"),
  nameEs: varchar("nameEs", { length: 50 }),
  displayNameEs: varchar("displayNameEs", { length: 100 }),
  descriptionEs: text("descriptionEs"),
  priceUsd: integer("priceUsd").default(0),
  priceMonthlyUsd: integer("priceMonthlyUsd").default(0),
  priceYearlyUsd: integer("priceYearlyUsd").default(0),
